...
public class NSGAIIExperiment {
    ...
    public NSGAIIExperiment(int populationSize, int maxEvaluations, double crossoverProbability, double mutationProbability, int execucoes) {
    ...
    public void execute() throws JMException, ClassNotFoundException {
        ...
        problem.writeHypervolume(dir.getPath() + "/A_RESULT", execucoes, populationSize, maxEvaluations, mutationProbability, crossoverProbability, 0, "NSGA-II", hypervolume, estimatedTime);
    }
} // NSGAII_main